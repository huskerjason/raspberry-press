...
function lamp {
	...
	sudo DEBIAN_FRONTEND=noninteractive apt-get install apache2 mariadb-server php php-{bcmath,imagick,mysql,xml,mbstring,zip,curl,intl} pwgen unzip -y < /dev/null > /dev/null
